...
export default function InfoFlowEdge({ id, sourceX, sourceY, targetX, targetY, sourcePosition, targetPosition, data, selected }) {
  ...
  return (
    <>
      ...
      <path ref={pathRef} d={edgePath} stroke={`url(#${gid})`} strokeWidth={sw} fill="none" strokeLinecap="butt" strokeDasharray="20 6" />
      ...
      {data?.label && (
        <EdgeLabelRenderer>
          <div style={{ position: 'absolute', transform: `translate(-50%,-50%) translate(${labelX}px,${labelY}px)`, backgroundColor: '#f5f5f5', color: COLOR, border: '1px solid #cccccc' }}
