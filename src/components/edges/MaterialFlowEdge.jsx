...
export default function MaterialFlowEdge({ id, sourceX, sourceY, targetX, targetY, sourcePosition, targetPosition, data, selected }) {
  ...
  return (
    <>
      ...
      {data?.label && (
        <EdgeLabelRenderer>
          <div style={{ position: 'absolute', transform: `translate(-50%,-50%) translate(${labelX}px,${labelY}px)`, backgroundColor: '#fff3e8', color: COLOR, border: '1px solid #ffccaa' }}
