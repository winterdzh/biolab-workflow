    ...
    >
      ...
      <div className="px-3 py-2.5">
        {data.loopType === 'condition'
          ? <div className="text-[11px] text-gray-600 font-mono bg-gray-50 rounded px-2 py-1 border border-gray-100">{data.condition || 'No condition'}</div>
          : <div className="text-[11px] text-gray-600">Repeat <span className="font-semibold" style={{ color: C }}>{data.count ?? 1}×</span></div>}
      </div>
